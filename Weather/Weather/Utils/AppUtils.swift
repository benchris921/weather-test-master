...
public extension String {
    ...
    func measureSize(for font: UIFont, constraindTo size: CGSize) -> CGSize {
        let attributedDictionary = [NSAttributedString.Key.font: font]
        let frame = self.boundingRect(with: size, options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: attributedDictionary, context: nil)
